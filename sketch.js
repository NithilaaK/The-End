...
function preload() {
  trex_running = loadAnimation("images/trex_img0.png", "images/trex_img1.png", "images/trex_img2.png");
  trex_collided = loadImage("images/sprite_0.png");
  groundImage = loadImage("images/ground0.png");
  cloudImage = loadImage("images/cloud_0.png");
  obstacle1 = loadImage("images/obstacle_0.png");
  obstacle2 = loadImage("images/obstacle_1.png");
  obstacle3 = loadImage("images/obstacle_2.png");
  obstacle4 = loadImage("images/obstacle_3.png");
  obstacle5 = loadImage("images/obstacle_4.png");
  obstacle6 = loadImage("images/obstacle_5.png");
  gameOverimg = loadImage("images/gameOver_0.png");
  restartimg = loadImage("images/restart_0.png");
}
function setup() {
  ...
  invisibleGround = createSprite(ground.x, 210, ground.width, 10);
  invisibleGround.visible = false;
  //Putting another invisible ground when the 1st ground reaches its end
  invisibleGround2 = createSprite(ground2.x, 210, ground.width, 10);
...
function spawnObstacles() {
  if (frameCount % 120 === 0) {
    //note obstacle.x
    var obstacle = createSprite(trex.x + displayWidth - 100, 190, 10, 40);
